        ...
        <div class="row">
            <div class="card pt-3 col-lg-9" style="border: none;">
                ...
                <div class="container-fluid p-2">
                    ...
                    $data = new videoModel();
                    $videos = $data->selectvideos();
                    $tamanoarray = is_array($videos) ? count($videos) : 0;
                    $registros = 15;
                    ...
                    $datosvideo = $data->selectvideosli();
                    ...
                    <div class="container-fluid col-12">
                        ...
                        if ($tamanoarray != 0) {
                            ...
                            if ($paginas > 1) {
                                ...
                                if ($_REQUEST['name'] != '1') {
                                    $ant = $_REQUEST['name'] - 1;
                                    echo '<a class="page-link" aria-label="previous" href="' . URL . 'noticiasvideo?name=' . $ant . '"><span aria-hidden="true" >&laquo;</span><span class="sr-only">anterior</span></a>';

                                    if ($pagina > 1) {
                                        echo '<li class="page-item"><a class="page-link" href="' . URL . 'noticiasvideo?name=' . ($pagina - 1) . '">' . $ant . '</a></li>';
                                    }
                                }
                                ...
                                if ($pagina < $paginas && $paginas > 1) {
                                    ...
                                    echo '<li class="page-item"><a class="page-link" href="' . URL . 'noticiasvideo?name=' . ($pagina + 1) . '">' . $sigui . '</a></li>';
                                    echo '<li class="page-item"><a class="page-link" aria-label="Next" href="' . URL . 'noticiasvideo?name=' . ($pagina + 1) . '"><span aria-hidden="true" >&raquo;</span><span class="sr-only">siguiente</span></a></li>';
                                }
                            ...
                            if ($_REQUEST['name'] > $paginas) {
                                Redirect::to("noticiasvideo?name=1");
                                exit;
                            }
                        }
                        ?>
